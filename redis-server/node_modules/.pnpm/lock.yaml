...
packages:
  ...
  /@types/express-serve-static-core/4.17.19:
    resolution: {integrity: sha512-DJOSHzX7pCiSElWaGR8kCprwibCB/3yW6vcT8VG3P0SJjnv19gnWG/AZMfM60Xj/YJIp/YCaDHyvzsFVeniARA==}
    dependencies:
      '@types/node': 15.0.2
      '@types/qs': 6.9.6
  ...
  /@types/redis/2.8.28:
    resolution: {integrity: sha512-8l2gr2OQ969ypa7hFOeKqtFoY70XkHxISV0pAwmQ2nm6CSPb1brmTmqJCGGrekCo+pAZyWlNXr+Kvo6L/1wijA==}
    dependencies:
      '@types/node': 15.0.2
    dev: true
  ...
  /dotenv/9.0.0:
    resolution: {integrity: sha512-yy3x9XjojW8ROTBePD25AcMoHqGHsvHmtfw8QWlpEXyMMXXPj6brUA464AptUvHuTPRmNz6Sd3ZLNLeJl6dHJA==}
    engines: {node: '>=10'}
    dev: true
  ...
  /ioredis/4.27.2:
    resolution: {integrity: sha512-7OpYymIthonkC2Jne5uGWXswdhlua1S1rWGAERaotn0hGJWTSURvxdHA9G6wNbT/qKCloCja/FHsfKXW8lpTmg==}
    engines: {node: '>=6'}
    dependencies:
      cluster-key-slot: 1.1.0
      debug: 4.3.1
